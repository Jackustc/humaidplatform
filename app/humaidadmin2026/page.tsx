        ...
        <div className="mb-8 flex items-start justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="flex-shrink-0 flex items-center gap-1.5 text-sm font-medium border border-gray-300 hover:border-red-400 text-gray-500 hover:text-red-500 px-3 py-2 rounded-md transition-colors"
            >
